...
export const TeamBuildingSection = () => {
  ...
  const filteredItineraries = itineraries?.filter(i => i.category === "team-building") || [];

  return (
    <section id="team-building" className="py-24 lg:py-32 bg-navy-light">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground font-sans max-w-2xl mx-auto">
            Strengthen your team's bond with our specially designed corporate retreats and team-building experiences.
          </p>
        </div>
